...
//                 CYCRAI 2027
//               </span>{" "}
//                 is the flagship international conference organised by the IEEE Computer Society, University of Engineering & Management Kolkata Student Branch Chapter, dedicated to advancing research, innovation, and collaboration at the intersection of cybersecurity, responsible artificial intelligence, and cryptography.
//             </p>

//             <p className="text-slate-400 text-lg leading-8">
//               The conference serves as a global platform bringing together researchers, academicians, industry leaders, entrepreneurs, and students to exchange ideas, present cutting-edge research, and foster meaningful collaborations. CYCRAI 2027 aims to shape the next generation of secure, responsible, and intelligent digital ecosystems through innovation, knowledge sharing, and interdisciplinary collaboration.
//             </p>

//             <p className="text-slate-400 text-lg leading-8">
//               Through keynote talks, technical paper presentations, workshops, tutorials, and industry sessions, CYCRAI 2027 aims to accelerate innovation and foster meaningful knowledge exchange while addressing real-world challenges in cybersecurity, responsible AI, cryptography, cloud computing, IoT, blockchain, and emerging digital infrastructure.
//             </p>
          ...
          >
            ...
            >
              ...
              <p className="text-slate-300 text-lg md:text-xl leading-8">
                ...
                IEEE Computer Society, University of Engineering & Management
